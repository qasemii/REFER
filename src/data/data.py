...
class DataModule(pl.LightningDataModule):
    ...
    def __init__(self,
                 ...
                 pct_train_rationales: float = None, pct_train_rationales_seed: int = None,
                 train_rationales_batch_factor: float = None,
                 attr_algo: str = None, train_shuffle: bool = False, train_rationale_selection: str = None,
                 annotation=None, data_type=None,
                 ):
        super().__init__()
    ...
    def setup(self, splits=['all']):
        ...
        for split in splits:
            ...
            self.data[split] = TextClassificationDataset(dataset, split, train_rationales_dataset,
